...
attribute shreg_extract : string;
    ...
    signal tmp_2_reg_200 : STD_LOGIC_VECTOR (255 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal tmp_2_reg_200_pp0_iter1_reg : STD_LOGIC_VECTOR (255 downto 0);
    signal p_Result_s_fu_86_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_Result_s_reg_208 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln29_fu_90_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln29_reg_214 : STD_LOGIC_VECTOR (0 downto 0);
    signal odd_delay_iq_V_reg_219 : STD_LOGIC_VECTOR (255 downto 0);
    signal lane_last_V_fu_105_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal lane_last_V_reg_224 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln870_fu_111_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal or_ln47_fu_189_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln45_fu_177_p3 : STD_LOGIC_VECTOR (255 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal p_Result_3_fu_139_p3 : STD_LOGIC_VECTOR (511 downto 0);
    signal p_Result_4_fu_146_p3 : STD_LOGIC_VECTOR (511 downto 0);
    signal select_ln33_1_fu_161_p3 : STD_LOGIC_VECTOR (511 downto 0);
    signal select_ln33_fu_153_p3 : STD_LOGIC_VECTOR (511 downto 0);
...
begin
    ...
    port map (
        ...
        d0 => tmp_2_reg_200_pp0_iter1_reg,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then
                even_lane_z1_V <= select_ln45_fu_177_p3;
                primed <= or_ln47_fu_189_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                lane_last_V_reg_224 <= lane_last_V_fu_105_p2;
                odd_delay_iq_V_reg_219 <= odd_delay_Array_q0;
                p_Result_s_reg_208 <= p_Result_s_fu_86_p1;
                tmp_2_reg_200 <= iq1_dout;
                tmp_2_reg_200_pp0_iter1_reg <= tmp_2_reg_200;
                xor_ln29_reg_214 <= xor_ln29_fu_90_p2;
            end if;
        end if;
    end process;
    ...
    add_ln870_fu_111_p2 <= std_logic_vector(unsigned(cycle_V) + unsigned(ap_const_lv9_1));
    ap_CS_fsm_pp0_stage0 <= ap_CS_fsm(0);
        ap_block_pp0_stage0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter3, iq1_empty_n, ap_done_reg, regslice_both_lanes_V_data_V_U_apdone_blk, lanes_TREADY_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter3 = ap_const_logic_1) and ((regslice_both_lanes_V_data_V_U_apdone_blk = ap_const_logic_1) or (lanes_TREADY_int_regslice = ap_const_logic_0))) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (lanes_TREADY_int_regslice = ap_const_logic_0)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or (iq1_empty_n = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter3, iq1_empty_n, ap_done_reg, regslice_both_lanes_V_data_V_U_apdone_blk, lanes_TREADY_int_regslice)
    begin
    ...
    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter3, iq1_empty_n, ap_done_reg, regslice_both_lanes_V_data_V_U_apdone_blk, lanes_TREADY_int_regslice)
    begin
    ...
    ap_block_state3_pp0_stage0_iter2_assign_proc : process(lanes_TREADY_int_regslice)
    begin
                ap_block_state3_pp0_stage0_iter2 <= (lanes_TREADY_int_regslice = ap_const_logic_0);
    end process;


    ap_block_state4_pp0_stage0_iter3_assign_proc : process(regslice_both_lanes_V_data_V_U_apdone_blk, lanes_TREADY_int_regslice)
    begin
                ap_block_state4_pp0_stage0_iter3 <= ((regslice_both_lanes_V_data_V_U_apdone_blk = ap_const_logic_1) or (lanes_TREADY_int_regslice = ap_const_logic_0));
    end process;
    ...
    even_delay_Array_ce0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, xor_ln29_reg_214)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            even_delay_Array_ce0 <= xor_ln29_reg_214(0);
        else 
    ...
    even_delay_Array_we0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, xor_ln29_reg_214)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            even_delay_Array_we0 <= xor_ln29_reg_214(0);
        else 
    ...
    lane_last_V_fu_105_p2 <= "1" when (cycle_V = ap_const_lv9_1FF) else "0";
    ...
    lanes_TDATA_int_regslice <= 
        select_ln33_1_fu_161_p3 when (p_Result_s_reg_208(0) = '1') else 
    ...
    odd_delay_Array_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, p_Result_s_fu_86_p1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            odd_delay_Array_ce0 <= p_Result_s_fu_86_p1(0);
        else 
    ...
    odd_delay_Array_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, p_Result_s_fu_86_p1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            odd_delay_Array_we0 <= p_Result_s_fu_86_p1(0);
        else 
            odd_delay_Array_we0 <= ap_const_logic_0;
        end if; 
    end process;

    or_ln47_fu_189_p2 <= (primed or lane_last_V_reg_224);
    p_Result_3_fu_139_p3 <= (odd_delay_iq_V_reg_219 & even_lane_z1_V);
    p_Result_4_fu_146_p3 <= (tmp_2_reg_200_pp0_iter1_reg & even_lane_z1_V);
    p_Result_s_fu_86_p1 <= cycle_V(1 - 1 downto 0);
    select_ln33_1_fu_161_p3 <= 
        p_Result_4_fu_146_p3 when (primed(0) = '1') else 
        ap_const_lv512_lc_1;
    select_ln33_fu_153_p3 <= 
        p_Result_3_fu_139_p3 when (primed(0) = '1') else 
        ap_const_lv512_lc_1;
    select_ln45_fu_177_p3 <= 
        even_delay_Array_q0 when (p_Result_s_reg_208(0) = '1') else 
        tmp_2_reg_200_pp0_iter1_reg;
    xor_ln29_fu_90_p2 <= (p_Result_s_fu_86_p1 xor ap_const_lv1_1);
end behav;
