...
module adc_to_opfb_process_lanes_even_delay_Array_V_core (
    clk,
    ce,
    din,
    addr,
...
module adc_to_opfb_process_lanes_even_delay_Array_V (
    clk,
    reset,
    address0,
    ce0,
...
adc_to_opfb_process_lanes_even_delay_Array_V_core #(
    .DATA_WIDTH( DataWidth ),
    .ADDR_WIDTH( AddressWidth ),
    .DEPTH( AddressRange ))
adc_to_opfb_process_lanes_even_delay_Array_V_core_U(
    .clk(clk),
    .ce(we0),
    .din(d0),
    .addr(address0),
