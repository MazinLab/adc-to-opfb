...
reg   [255:0] tmp_2_reg_200;
reg    ap_block_pp0_stage0_11001;
reg   [255:0] tmp_2_reg_200_pp0_iter1_reg;
wire   [0:0] p_Result_s_fu_86_p1;
reg   [0:0] p_Result_s_reg_208;
wire   [0:0] xor_ln29_fu_90_p2;
reg   [0:0] xor_ln29_reg_214;
reg   [255:0] odd_delay_iq_V_reg_219;
wire   [0:0] lane_last_V_fu_105_p2;
reg   [0:0] lane_last_V_reg_224;
wire   [8:0] add_ln870_fu_111_p2;
wire   [0:0] or_ln47_fu_189_p2;
wire   [255:0] select_ln45_fu_177_p3;
reg    ap_block_pp0_stage0_01001;
wire   [511:0] p_Result_3_fu_139_p3;
wire   [511:0] p_Result_4_fu_146_p3;
wire   [511:0] select_ln33_1_fu_161_p3;
wire   [511:0] select_ln33_fu_153_p3;
reg   [0:0] ap_NS_fsm;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        even_delay_Array_ce0 = xor_ln29_reg_214;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        even_delay_Array_we0 = xor_ln29_reg_214;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        odd_delay_Array_ce0 = p_Result_s_fu_86_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        odd_delay_Array_we0 = p_Result_s_fu_86_p1;
    end else begin
...
assign add_ln870_fu_111_p2 = (cycle_V + 9'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter3 == 1'b1) & ((regslice_both_lanes_V_data_V_U_apdone_blk == 1'b1) | (lanes_TREADY_int_regslice == 1'b0))) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (lanes_TREADY_int_regslice == 1'b0)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | (iq1_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter3 == 1'b1) & ((regslice_both_lanes_V_data_V_U_apdone_blk == 1'b1) | (lanes_TREADY_int_regslice == 1'b0))) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (lanes_TREADY_int_regslice == 1'b0)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | (iq1_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter3 == 1'b1) & ((regslice_both_lanes_V_data_V_U_apdone_blk == 1'b1) | (lanes_TREADY_int_regslice == 1'b0))) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (lanes_TREADY_int_regslice == 1'b0)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | (iq1_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = (lanes_TREADY_int_regslice == 1'b0);
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter3 = ((regslice_both_lanes_V_data_V_U_apdone_blk == 1'b1) | (lanes_TREADY_int_regslice == 1'b0));
end
...
assign lane_last_V_fu_105_p2 = ((cycle_V == 9'd511) ? 1'b1 : 1'b0);

assign lanes_TDATA_int_regslice = ((p_Result_s_reg_208[0:0] == 1'b1) ? select_ln33_1_fu_161_p3 : select_ln33_fu_153_p3);

assign lanes_TVALID = regslice_both_lanes_V_data_V_U_vld_out;

assign or_ln47_fu_189_p2 = (primed | lane_last_V_reg_224);

assign p_Result_3_fu_139_p3 = {{odd_delay_iq_V_reg_219}, {even_lane_z1_V}};

assign p_Result_4_fu_146_p3 = {{tmp_2_reg_200_pp0_iter1_reg}, {even_lane_z1_V}};

assign p_Result_s_fu_86_p1 = cycle_V[0:0];

assign select_ln33_1_fu_161_p3 = ((primed[0:0] == 1'b1) ? p_Result_4_fu_146_p3 : 512'd0);

assign select_ln33_fu_153_p3 = ((primed[0:0] == 1'b1) ? p_Result_3_fu_139_p3 : 512'd0);

assign select_ln45_fu_177_p3 = ((p_Result_s_reg_208[0:0] == 1'b1) ? even_delay_Array_q0 : tmp_2_reg_200_pp0_iter1_reg);

assign xor_ln29_fu_90_p2 = (p_Result_s_fu_86_p1 ^ 1'd1);
